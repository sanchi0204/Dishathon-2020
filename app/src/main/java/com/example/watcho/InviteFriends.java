            ...
            //  btn_whatsapp_each_word = findViewById(R.id.btn_whatsapp2);
                ...
                btn_choose.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        new MultiContactPicker.Builder(InviteFriends.this)
                                .hideScrollbar(false)
                                .showTrack(true)
                                .searchIconColor(Color.WHITE)
                                .setChoiceMode(MultiContactPicker.CHOICE_MODE_MULTIPLE)
                                .handleColor(ContextCompat.getColor(InviteFriends.this, R.color.colorPrimary))
                                .bubbleColor(ContextCompat.getColor(InviteFriends.this, R.color.colorPrimary))
                ...
                btn_sms.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        MySMSservice.startActionSMS(getApplicationContext(),getString(R.string.sms_msg),
...
//                });
                ...
                btn_whatsapp.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        MySMSservice.startActionWHATSAPP(getApplicationContext(),getString(R.string.sms_msg),
...
//                });
    ...
    public void openDialog() {
        ...
        dialog.setContentView(R.layout.earn_coin);
